...
class QuizApp {
    ...
    async loadQuestions() {
        ...
        const defaultQuestions = [
            ...
            {
                question: "Python is a ___typed language.",
                options: ["Statically", "Dynamically", "Weakly", "None of the above"],
                answer: "Dynamically"
            },
            {
            ...
            },
            {
                ...
                options: ["They allow duplicate values", "They maintain insertion order", "They are mutable", "They are immutable"],
            ...
            {
                question: "Which of the these data types is not hashable in Python? ",
                options: ["str", "tuple", "list", "frozenset"],
                answer: "list"
            },
            {
                question: "Who Developed Python?",
                options: ["Guido van Rossum", "Albert Einstein", "Charles Babbage", "Marie Curie"],
